  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      if (user) {
        ...
        // Check user_type to determine routing
        if (supabase) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!authResult.success || !authResult.user) {
        ...
        setLocalError(authResult.error || 'Login failed')
        setLocalLoading(false)
        return
      }

      // Then login to our app store
